...
@Component({
  selector: 'app-tree-view3',
  templateUrl: './tree-view3.component.html',
  styleUrls: ['./tree-view3.component.scss']
})
export class TreeView3Component implements OnInit {
  ...
  dataSource: any = [];
  displayedColumns: string[] = ['id','Student_name','Datetime'];
  // Set up the paginator
  pageSizeOptions: number[] = [5, 10, 25, 100];
  pageSize = 5;
...
data2:any=[]
 get_students(){
   this._api.get_students(this.id).subscribe((res) =>{
